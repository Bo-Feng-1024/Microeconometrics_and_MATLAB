...
% X : N-by-K independent variable, where K is the number of explanatory
% variables
%------------------------------------------------
...
% coefficients K
N = length(y);
K = size(X,2); % M = size(X,DIM) returns the lengths of the specified dimensions in a row vector.
